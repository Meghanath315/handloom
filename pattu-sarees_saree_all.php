...
<head>
	...
	<link href="pattu-sarees_saree_style.css" rel="stylesheet">
</head>
<body> 
<!-- Navigation -->
...
<main>
	<a href="pattu-sarees_saree_all.php" id="category1">
		<div class="col-12">
			<h1 class="display-4">Pattu Sarees</h1>
			<p>Starting Price Rs.7500/-</p>
		</div>
	</a>
	<div class="container gallery-container">
		<div class="tz-gallery">
			<div class="row">
				<?php
					$dir = glob('saree crop images/pattu sarees home/all saree images/*.jpg', GLOB_BRACE);
  ...
  <!--   <a href="pattu-sarees_sub1.php" id="category1">
    	<div class="col-12">
    		<h4 class="display-5">Double Border Ikkat Jakat Saree</h4>
    	</div>
    </a>
	...
	<div class="row text-center padding">
			...
			<div id="slides1" class="carousel slide" data-ride="carousel">
	            ...
	            <div class="carousel-inner">
					<div class="carousel-item active demo-item">
						<a href="#"><img src="saree crop images/pattu sarees home/double border ikkat jakat saree home/1.jpg"></a>
					</div>
					<div class="carousel-item">
						<a href="#"><img src="saree crop images/pattu sarees home/double border ikkat jakat saree home/2.jpg"></a>
					</div>
				</div>
			</div>
		...
		<div class="col-xs-12 col-sm-6 col-md-4">
			<div id="slides2" class="carousel slide" data-ride="carousel">
	            ...
	            <div class="carousel-inner">
					<div class="carousel-item active demo-item">
						<a href="#"><img src="saree crop images/pattu sarees home/double border ikkat jakat saree home/3.jpg"></a>
					</div>
					<div class="carousel-item">
						<a href="#"><img src="saree crop images/pattu sarees home/double border ikkat jakat saree home/4.jpg"></a>
					</div>
				</div>
			</div>
		...
		<div class="col-xs-12 col-sm-6 col-md-4">
			<div id="slides3" class="carousel slide" data-ride="carousel">
	            ...
	            <div class="carousel-inner">
					<div class="carousel-item active demo-item">
						<a href="#"><img src="saree crop images/pattu sarees home/double border ikkat jakat saree home/5.jpg"></a>
					</div>
					<div class="carousel-item">
						<a href="#"><img src="saree crop images/pattu sarees home/double border ikkat jakat saree home/6.jpg"></a>
					</div>
				</div>
			</div>
...
<hr class="my-4">
	...
	<a href="pattu-sarees_sub2.php" id="category1">
    	<div class="col-12">
    		<h4 class="display-5">Ikkat Jakat Saree</h4>
    	</div>
    </a>
    <div class="container-fluid padding">
	<div class="row text-center padding">
		<div class="col-xs-12 col-sm-6 col-md-6">
			<div id="slides4" class="carousel slide" data-ride="carousel">
	            ...
	            <div class="carousel-inner">
					<div class="carousel-item active demo-item">
						<a href="#"><img src="saree crop images/pattu sarees home/ikkat jakat saree home/1.jpg"></a>
					</div>
					<div class="carousel-item">
						<a href="#"><img src="saree crop images/pattu sarees home/ikkat jakat saree home/2.jpg"></a>
					</div>
				</div>
			</div>
		...
		<div class="col-xs-12 col-sm-6 col-md-6">
			<div id="slides5" class="carousel slide" data-ride="carousel">
	            ...
	            <div class="carousel-inner">
					<div class="carousel-item active demo-item">
						<a href="#"><img src="saree crop images/pattu sarees home/ikkat jakat saree home/3.jpg"></a>
					</div>
					<div class="carousel-item">
						<a href="#"><img src="saree crop images/pattu sarees home/ikkat jakat saree home/4.jpg"></a>
					</div>
				</div>
			</div>
...
<hr class="my-4">
    ...
    <a href="pattu-sarees_sub3.php" id="category1">
    	<div class="col-12">
    		<h4 class="display-5">Pattu Rajkoti Saree</h4>
    	</div>
    </a>
    <div class="container-fluid padding">
	<div class="row text-center padding">
		<div class="col-xs-12 col-sm-6 col-md-4">
			<div id="slides7" class="carousel slide" data-ride="carousel">
	            ...
	            <div class="carousel-inner">
					<div class="carousel-item active demo-item">
						<a href="#"><img src="saree crop images/pattu sarees home/Raj koti sarees home/1.jpg"></a>
					</div>
					<div class="carousel-item">
						<a href="#"><img src="saree crop images/pattu sarees home/Raj koti sarees home/2.jpg"></a>
					</div>
				</div>
			</div>
		...
		<div class="col-xs-12 col-sm-6 col-md-4">
			<div id="slides8" class="carousel slide" data-ride="carousel">
	            ...
	            <div class="carousel-inner">
					<div class="carousel-item active demo-item">
						<a href="#"><img src="saree crop images/pattu sarees home/Raj koti sarees home/3.jpg"></a>
					</div>
					<div class="carousel-item">
						<a href="#"><img src="saree crop images/pattu sarees home/Raj koti sarees home/4.jpg"></a>
					</div>
				</div>
			</div>
		...
		<div class="col-xs-12 col-sm-6 col-md-4">
			<div id="slides9" class="carousel slide" data-ride="carousel">
	    		<ul class="carousel-indicators1">	
					<li data-target="#slides" data-slide-to="0" class="active"></li>
					<li data-target="#slides" data-slide-to="1"></li>
				</ul>
	            <div class="carousel-inner">
					<div class="carousel-item active demo-item">
						<a href="#"><img src="saree crop images/pattu sarees home/Raj koti sarees home/5.jpg"></a>
					</div>
					<div class="carousel-item">
						<a href="#"><img src="saree crop images/pattu sarees home/Raj koti sarees home/6.jpg"></a>
					</div>
				</div>
			</div>
			<a class="carousel-control-prev" href="#slides9" role="button" data-slide="prev">
      				<span class="carousel-control-prev-icon" aria-hidden="true"></span>
      				<span class="sr-only">Previous</span>
    		</a>
    		<a class="carousel-control-next" href="#slides9" role="button" data-slide="next">
      				<span class="carousel-control-next-icon" aria-hidden="true"></span>
      				<span class="sr-only">Next</span>
    		</a>
		</div>

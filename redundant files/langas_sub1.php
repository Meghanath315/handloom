...
<a href="langas_sub1.php" id="category1">
		<div class="col-12">
			<h1 class="display-4">Double Border Ikkat Jakat Langa</h1>
	...
	<div class="container gallery-container">
		<div class="tz-gallery">
			<div class="row">
				<?php
					$dir = glob('saree crop images/Langas home/double border ikkat jakat langa home/double border ikkat jakat langas/*.jpg', GLOB_BRACE);

...
<a href="langas_sub2.php" id="category1">
		<div class="col-12">
			<h1 class="display-4">Petu Langa</h1>
			<p class="display-5">(Starting Price - Rs. 5300/- )</p>
		</div>
	</a>
	<div class="container gallery-container">
		<div class="tz-gallery">
			<div class="row">
				<?php
					$dir = glob('saree crop images/Langas home/petu langa home/petu langas/*.jpg', GLOB_BRACE);

...
<nav class="navbar navbar-expand-md navbar-light bg-light sticky-top">
	 	...
	 	<ul class="navbar-nav ml-auto">
	 		<li class="nav-item dropdown">
	 			...
	 			<div class="dropdown-menu" aria-labelled="navbarDropdown">
	 				<a class="dropdown-item" href="pattu-sarees_saree_all.html">Pattu Sarees</a>
	 				<div class="dropdown-divider"></div>
	 				<a class="dropdown-item" href="langas.html">Langas</a>
	 				<!-- <div class="dropdown-divider"></div>
	...
	<a href="pattu-sarees_sub1.php" id="category1">
		<div class="col-12">
			<h1 class="display-4">Double Border Ikkat Jakat Saree</h1>
			<p class="display-5">(Starting Price - Rs. 17000/- )</p>
		</div>
	</a>
	<div class="container gallery-container">
		<div class="tz-gallery">
			<div class="row">
				<?php
					$dir = glob('saree crop images/pattu sarees home/double border ikkat jakat saree home/double border ikkat jakat sarees/*.jpg', GLOB_BRACE);

...
<a href="pattu-sarees_sub2.php" id="category1">
		<div class="col-12">
			<h1 class="display-4">Ikkat Jakat Saree</h1>
			<p class="display-5">(Starting Price - Rs. 10500/-)</p>
		</div>
	</a>
	<div class="container gallery-container">
		<div class="tz-gallery">
			<div class="row">
				<?php
					$dir = glob('saree crop images/pattu sarees home/ikkat jakat saree home/ikkat jakat saree/*.jpg', GLOB_BRACE);

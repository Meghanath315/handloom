...
<a href="langas_sub3.php" id="category1">
		<div class="col-12">
			<h1 class="display-4">Big Border Langa</h1>
			<p class="display-5">(Starting Price - Rs. 5000/- )</p>
		</div>
	</a>
	<div class="container gallery-container">
		<div class="tz-gallery">
			<div class="row">
				<?php
					$dir = glob('saree crop images/Langas home/Big border langa home/Big border langas/*.jpg', GLOB_BRACE);

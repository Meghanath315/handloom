...
<a href="pattu-sarees_sub3.php" id="category1">
		<div class="col-12">
			<h1 class="display-4">Pattu Rajkoti Sarees</h1>
			<p class="display-5">(Starting Price - Rs. 7500/- )</p>
		</div>
	</a>
	<div class="container gallery-container">
		<div class="tz-gallery">
			<div class="row">
				<?php
					$dir = glob('saree crop images/pattu sarees home/Raj koti sarees home/Raj koti sarees/*.jpg', GLOB_BRACE);
